...
public class TfliteAudioPlugin implements MethodCallHandler, StreamHandler, FlutterPlugin, ActivityAware,
    ...
    private void onAttachedToEngine(Context applicationContext, BinaryMessenger messenger) {
        ...
        // Initialize FlutterLoader
        this.flutterLoader = new FlutterLoader();
        this.flutterLoader.startInitialization(applicationContext);
        this.flutterLoader.ensureInitializationComplete(applicationContext, null);
    ...
    private void loadAudioFile() {
        ...
        try {
            if (isAsset) {
                // Get exact location of the file in the assets folder.
            ...
            Log.d(LOG_TAG, "Audio file successfully loaded");
